...
export class CheckoutInfoPage {
  ...
  province: string;
  postalcode: string;
}, firstName: any, lastName: any, houseNumber: any, street: any, subDistrict: any, district: any, province: any, postalCode: any) {
  await this.page.getByTestId('customer-title').selectOption({ label: data.title });
